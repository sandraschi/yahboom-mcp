...
import { Square, Loader2, ShieldAlert, Wifi, WifiOff } from 'lucide-react';
                ...
                <header className="h-20 border-b border-white/5 flex items-center justify-between px-10 relative z-20 backdrop-blur-xl bg-slate-900/20">
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-3">
                           ...
                           <span className="text-[10px] uppercase tracking-[0.3em] font-black text-slate-400">Boomy System Core</span>
                        </div>
                   ...
                   >
                       {stopping ? <Loader2 className="w-5 h-5 animate-spin" /> : <Square className="fill-current w-5 h-5" />}
