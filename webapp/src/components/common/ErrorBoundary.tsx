            ...
            return (
                <div style={{
                    ...
                    <div style={{
                        ...
                        <h1 style={{ fontSize: '24px', fontWeight: 900, color: 'white', marginBottom: '16px', textTransform: 'uppercase' }}>Subsystem Failure</h1>
                        <p style={{ color: '#94a3b8', fontSize: '14px', lineHeight: 1.6, marginBottom: '40px' }}>
                            The G1 Mission Control interface encountered a critical rendering exception. Virtual telemetry link may be unstable.
                        </p>
