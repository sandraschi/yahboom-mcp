...
export const api = {
  ...
  getLmStudioStatus: () => request<OllamaStatus>("/api/v1/settings/lmstudio/status"),
  getLmStudioModels: () => request<OllamaModelsResponse>("/api/v1/settings/lmstudio/models"),
  ...
  audioListStored: () =>
    request<{ success: boolean; files: string[]; count: number }>("/api/v1/control/tool", {
      method: "POST",
