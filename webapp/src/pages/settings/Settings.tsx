...
const Settings: React.FC = () => {
  ...
  const [lmstudioStatus, setLmstudioStatus] = useState<OllamaStatus | null>(null);
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      if (provider === "lmstudio") {
        ...
        const olModels = await api.getOllamaModels().catch(() => ({ models: [] }));
  ...
  const providerStatus = llmSettings?.provider === "lmstudio" ? lmstudioStatus : ollamaStatus;
      ...
      >
        <div className="flex items-center gap-6 mb-6">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-bold text-white leading-tight mb-1">Local LLM</h3>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <span className="block text-sm font-bold text-white">{prov.label}</span>
        ...
        {loading && !providerStatus ? (
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              {PROVIDERS.filter((p) => p.value === llmSettings?.provider).map((p) => (
                <span
                  key={p.value}
