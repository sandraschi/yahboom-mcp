...
import { 
    Zap, Loader2, Volume2, RefreshCw, Palette, ScreenShare, Trash2, 
    ArrowRightLeft, AlertCircle, Info, Radio, Layers
} from 'lucide-react';

const PATTERNS = [
    { id: 'patrol', label: 'Patrol Car', sid: 'patrol', color: 'bg-gradient-to-r from-red-600 via-zinc-200 to-blue-600' },
    { id: 'rainbow', label: 'Rainbow Flow', sid: 'rainbow', color: 'bg-gradient-to-r from-red-500 via-green-500 to-blue-500' },
    { id: 'breathe', label: 'Breathe RGB', sid: 'breathe', color: 'bg-gradient-to-r from-blue-600 to-cyan-400' },
    { id: 'fire', label: 'Fire Flicker', sid: 'fire', color: 'bg-gradient-to-r from-orange-600 to-red-500' },
...
const StatusBadge = ({ detected, label }: { detected: boolean, label: string }) => (
    <div className={`px-4 py-1.5 rounded-full border text-[9px] font-black uppercase tracking-widest flex items-center gap-2 transition-all ${
        ...
        <div className={`w-1 h-1 rounded-full ${detected ? 'bg-green-500 animate-pulse' : 'bg-zinc-800'}`} />
        {label}
    </div>
);
...
export default function Peripherals() {
    ...
    const [oledLoading, setOledLoading] = useState<string | null>(null);
                    ...
                    <div className="relative z-10 space-y-10">
                        <div className="flex items-center justify-between">
                            <div className="space-y-1">
                                ...
                                <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-[0.2em] px-1">Chrono-RGB Core</p>
                            </div>
                            ...
                            {PATTERNS.map((pattern) => (
                                ...
                                >
                                    ...
                                    <div className="relative h-full flex flex-col justify-end p-6">
                                        <span className="text-[10px] font-black uppercase tracking-[0.2em] mb-1 opacity-50">{pattern.id}</span>
                                        <span className="text-xs font-black tracking-widest uppercase">{pattern.label}</span>
                    ...
                    <div className="relative z-10 space-y-10">
                        <div className="flex items-center justify-between">
                            <div className="space-y-1">
                                ...
                                <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-[0.2em] px-1">I2C Pixel Matrix</p>
                            </div>
                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
                            ...
                            <div className="space-y-6">
                                <label className="text-[11px] font-black text-zinc-600 uppercase tracking-[0.25em]">Flash Message</label>
