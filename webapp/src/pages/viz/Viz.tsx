...
function G1Robot({ yaw, linearVel }: { yaw: number; linearVel: number }) {
  ...
  return (
    <group ref={rootRef}>
      ...
      <Line
        points={[
          [0, 0.15 + WHEEL_AXLE_Y, 0],
          [0, 0.15 + WHEEL_AXLE_Y, 0.25],
        ]}
        color="#6366f1"
        lineWidth={2}
      />
  ...
  return (
    <div className="flex flex-col" style={{ height: "calc(100vh - 120px)" }}>
      ...
      <div className="flex items-center justify-between px-1 pb-4">
        ...
        <div
          className={`flex items-center gap-2 px-3 py-1.5 rounded-xl border text-xs font-bold uppercase tracking-widest ${
            connected
      ...
      >
        ...
        <Stat
          icon={Activity}
          label="Ang. Vel"
          value={`${angularVel.toFixed(2)} r/s`}
          color="purple"
        />
      </motion.div>
    </div>
